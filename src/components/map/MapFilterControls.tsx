...
export default function MapFilterControls({
  ...
  return (
    <>
      ...
      <button
        onClick={toggleLeftSidebar}
        className={`absolute top-1/2 z-[1200] bg-white shadow-lg rounded-r-xl p-3 transform -translate-y-1/2 hover:bg-[--cottage-secondary] transition-all duration-200 border-l border-t border-b border-[--cottage-neutral-light] ${isLeftSidebarVisible ? 'left-80' : 'left-0'}`}
